        ...
        <div class="table-box col-lg second-section">
            ...
            <div>
                <div>
                    <div>
                        ...
                        <div class="notice-regi-text">
                            <textarea class="form-control" placeholder="FAQ 수정 내용 입력" id="floatingTextarea" style="height: 500px"></textarea>
                        </div>
                    </div>
                ...
                <div class="notice-regi-btn">
                    <button class="btn btn-outline-secondary notice-modi-btn" type="button">수정</button>
